...
const Page = () => { /* ligne 16 absence de code pour le triage */
const { data } = useData();
  ...
  return <>
    ...
    <footer className="row">
      <div className="col presta">
        ...
        {last === null ? ( "loading" ) : ( 
            <EventCard
              imageSrc={last?.cover ? last.cover : ''}  /* Definition de la valeur de "imageSrc" */
              title={last?.title ? last.title : ''}  /* Definition de la valeur de "title" */
